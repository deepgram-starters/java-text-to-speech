...
Java (Javalin) demo app for Deepgram Text-to-Speech.
...
| File | Purpose |
|------|---------|
| `src/main/java/com/deepgram/starter/App.java` | Main backend — API endpoints and request handlers |
...
```
feat(java-text-to-speech): add diarization support
fix(java-text-to-speech): resolve WebSocket close handling
refactor(java-text-to-speech): simplify session endpoint
