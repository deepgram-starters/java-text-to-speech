...
help:
	@echo "Java Text-to-Speech - Available Commands"
	@echo "========================================="
	@echo ""
	@echo "Setup:"
...
start-backend:
	...
	@if [ ! -f "target/java-text-to-speech-1.0.0-shaded.jar" ]; then \
		echo "==> Building backend..."; \
		mvn clean package -q; \
	fi
	@echo "==> Starting backend on http://localhost:8081"
	java -jar target/java-text-to-speech-1.0.0-shaded.jar
